...
@Data
@Builder
public class RecoveryActionListDTO {
    private Long id;
    private String tipo;
    ...
    public static RecoveryActionListDTO from(RecoveryAction r, String restauranteNome) {
        return RecoveryActionListDTO.builder()
                .id(r.getId())
